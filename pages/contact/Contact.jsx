        ...
        <div className="h-screen w-screen border flex items-center justify-center px-3 md:px-32">
            ...
            <div className="h-5/6 w-full grid grid-cols-2 gap-y-10">
                ...
                <div className="col-span-2 md:col-span-1 h-auto">
                    ...
                    <textarea id="mail" className="border border-white w-3/4 ml-3 h-3/5 mt-5 outline-none px-3 py-3 text-white md:text-lg md:mt-10"
                    ...
                    <div className="w-3/4 h-auto ml-3 mt-3" dir="rtl">
                ...
                <div className="col-span-2 border-t border-white md:col-span-1 md:border-l md:border-t-0 md:px-4">
                    ...
                    <h3 className="mt-2 ml-9 text-stone-300 md:text-lg"> 0930 561 2332 </h3>
