    ...
    return (
        ...
        <div className="grid grid-cols-5 h-24 col-span-10 md:col-span-2 border border-white rounded-md md:rounded-lg md:h-auto">
            ...
            <div className="col-span-2 p-2 md:col-span-5">
                ...
                <Image src={props?.image} className="w-full h-full rounded-md" alt={props?.name} width={120} height={120} />
            ...
            <div className="col-span-3 md:col-span-5">
                ...
                <h1 className="w-full text-white text-lg mt-3 md:text-center md:text-xl"> {props?.name} </h1>
